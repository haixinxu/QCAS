// !!!!!     Modified for Qcas.       !!!!!
//     For the original version of this file see src/qtmmlwidget.cpp 
/****************************************************************************
**
** 
...
/* g_xml_entity_data[] is too big for some qt libs , it can't be fully included in QDomDocument.

  So we keep only a limited number of entries, enough for giac.
				    ...
				    int *errorLine, int *errorColumn)
{
    ...
    QDomDocument dom;
    if (!dom.setContent(prefix + text, false, errorMsg, errorLine, errorColumn)) { // FH: I got PB with some qt libs if prefix is too big
	if (errorLine != 0)
